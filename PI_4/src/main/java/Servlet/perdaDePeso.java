 ...
 */
@WebServlet(name = "perdaDePeso", urlPatterns = {"/perdaDePeso"})
public class perdaDePeso extends HttpServlet {

    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        ArrayList<Produto> listaProd = new Controller.ControllerListarProduto().getProdutosClientePerdaPeso();
