...
CREATE TABLE PEDIDO(
    ...
    DATA_DE_COMPRA VARCHAR(150) NOT NULL,
    VALOR_TOTAL NUMERIC(10,2) NOT NULL,
...
ALTER TABLE PEDIDO
ADD VALOR_TOTAL NUMERIC(10,2) NOT NULL;
