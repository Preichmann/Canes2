    ...
    <body>
        ...
        <main>
            <div class="container mt-5 mb-5" id="produtos">
                <h3 class="title-default mb-5">Pedidos</h3>
                    <div class="card-body justify-content-between">
                        <div class="d-flex flex-row">
                            <h6 class="cart-label"><c:out value="ID do Pedido" /></h6>
                            <h6 class="cart-label"><c:out value="Horário da Compra" /></h6>
                            <h6 class="cart-label"><c:out value="Valor" /></h6>
                        ...
                        <div class="card-body justify-content-between">
                            <div class="d-flex flex-row">
                                <form class="d-flex flex-row justify-content-between" style="width: 100%;" name="AtualizarPedido" method="get"
                                    ...
                                    <input type="submit" value="Editar Status" class="btn btn-cor-especial">
                                </form>
                            </div>
                        </div>
                    </article>
