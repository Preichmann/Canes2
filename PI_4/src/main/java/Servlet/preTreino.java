 ...
 * @author nik_r
 */
@WebServlet(name = "preTreino", urlPatterns = {"/preTreino"})
public class preTreino extends HttpServlet {


    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        ArrayList<Produto> listaProd = new Controller.ControllerListarProduto().getProdutosClientePreTreino();
