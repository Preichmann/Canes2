    ...
    <body>
        ...
        <main>
            <div class="container mt-5" id="produtos">
                <h3 class="title-default mb-5">Endereços de Entrega</h3>
                
                <c:forEach items="${ListaEntrega}" var="listaEndereco">
                    <article class="card mt-3">
                        <div class="card-body justify-content-between">
                            <div class="d-flex flex-row">
                                <form class="d-flex flex-row justify-content-between" style="width: 100%;" method="post"
                                    ...
                                    <h6 class="card-title" style="width:200px;margin: 0;display: flex;align-items: center;"><c:out value="${listaEndereco.getCep()}" /></h6>
                ...
                <form class="mt-5 mb-5" style="width: 100%;" name="CadastrarEntrega" method="get"
